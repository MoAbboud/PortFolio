# Benchmark run: local-extractor

- Started 2026-09-14T20:18:27+00:00, commit `4ab0493`
- Reader and summariser: `qwen2.5:3b` (read prompt v1, summarise prompt v2)
- herder extractor: `local`; budgets: 500, 3000 tokens
...
| --- | --- | --- | --- | --- | --- | --- |
| herder[local] @ 3000 | 0.20 (44 of 222) | 0.00 (0 of 39) | 0.01 (3 of 222) | 12.4x | 272 s | 0 |
| herder[local] @ 500 | 0.14 (30 of 221) | 0.00 (0 of 39) | 0.01 (2 of 221) | 34.2x | 272 s | 0 |

## By archetype

| Archetype | Method | Recall | Hallucination |
| --- | --- | --- | --- |
| coding | herder[local] @ 3000 | 0.16 (10 of 61) | 0.00 (0 of 10) |
| coding | herder[local] @ 500 | 0.15 (9 of 61) | 0.00 (0 of 10) |
| handover | herder[local] @ 3000 | 0.20 (11 of 56) | 0.00 (0 of 10) |
| handover | herder[local] @ 500 | 0.14 (8 of 56) | 0.00 (0 of 10) |
| planning | herder[local] @ 3000 | 0.25 (13 of 52) | 0.00 (0 of 10) |
| planning | herder[local] @ 500 | 0.19 (10 of 52) | 0.00 (0 of 10) |
| research | herder[local] @ 3000 | 0.19 (10 of 53) | 0.00 (0 of 9) |
| research | herder[local] @ 500 | 0.06 (3 of 52) | 0.00 (0 of 9) |

## Recall by kind of fact

| Method | decision | constraint | preference | identity | fact | open_thread | code_state | artifact_ref | glossary |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| herder[local] @ 3000 | 0.18 (11 of 60) | 0.41 (13 of 32) | 0.13 (3 of 23) | 0.10 (1 of 10) | 0.09 (6 of 67) | 0.42 (10 of 24) | 0.00 (0 of 5) | - | 0.00 (0 of 1) |
| herder[local] @ 500 | 0.13 (8 of 60) | 0.28 (9 of 32) | 0.09 (2 of 23) | 0.10 (1 of 10) | 0.05 (3 of 66) | 0.29 (7 of 24) | 0.00 (0 of 5) | - | 0.00 (0 of 1) |
...
| --- | --- | --- | --- |
| herder[local] @ 3000 | 0.24 (26 of 108) | 0.18 (16 of 89) | 0.08 (2 of 25) |
| herder[local] @ 500 | 0.16 (17 of 108) | 0.12 (11 of 88) | 0.08 (2 of 25) |
...
| Fact | Truth | herder[local] @ 3000 | herder[local] @ 500 |
| --- | --- | --- | --- |
...
| f011 No part of the system may call out to a cloud provider. | T | - | - |
| f012 Stock quantities are never allowed to go negative, and a write that would cause one is refused. | T | - | T |
| f013 Every stock change must record who made it and when. | T | - | - |
...
| f022 Reorder suggestions go to Marisol only. | F | - | - |
| f023 Reorder emails go to both Marisol and the shop manager of the shop concerned. | T | - | - |
...
| f009 If the NAS disk is nearly full the tool stops cleanly and reports it rather than leaving a half-copied file behind. | T | T | - |
| f010 Photos are sorted into folders by year and then month, like 2024/07. | T | - | - |
| f011 Photos with no EXIF date are filed using the file's modification time. | F | - | - |
| f012 Photos with no EXIF date go into a folder called undated. | T | - | - |
...
| f032 How long to keep log files is still undecided. | T | - | - |
| f033 How to handle iPhone Live Photos, which arrive as a pair of files, is still undecided. | T | - | - |
...
| f024 New starters get their laptop set up on their first morning. | T | T | T |
...
| f009 Support can approve refunds under €50 without asking anyone. | T | - | - |
...
| f018 Booking data is never shared from one customer account to another without written permission, even between people claiming to be colleagues. | T | T | - |
...
| Fact | Truth | herder[local] @ 3000 | herder[local] @ 500 |
| --- | --- | --- | --- |
| f001 Hearth Roasters is a small coffee roastery with one café, planning a second location. | T | - | - |
...
| f006 The second location opens in the Eastgate neighbourhood. | T | - | - |
...
| f010 The new site is a café only; all roasting stays at the original site. | T | - | - |
| f011 The target opening month is June. | F | - | - |
| f012 The target opening month is September. | T | - | - |
| f013 Builders can't start until spring, which pushed the opening back. | T | - | - |
| f014 The fit-out budget is £120,000. | F | - | F |
| f015 The fit-out budget is capped at £85,000. | T | T | T |
| f016 The bank won't lend more than £85,000 for the fit-out without investors. | T | - | - |
| f017 The business will not take on outside investors; ownership stays with the user and their sister. | T | T | - |
...
| f021 The lease must include a break clause no later than year three. | T | - | - |
| f022 A dedicated manager is hired for the new café rather than the owner splitting their time. | T | - | - |
...
| f027 The user wants risks stated bluntly. | T | - | - |
| f028 The user prefers plain spreadsheets to specialised planning software. | T | - | - |
| f029 Whether to serve food beyond pastries is undecided. | T | - | - |
| f030 The name for the second café is undecided — same name or a variation. | T | - | - |
...
| f011 The pilot covers maths and reading only. | T | - | - |
| f012 Science tutoring is offered from the start, since several volunteers studied it. | F | - | - |
| f013 Science tutoring can come later, after the pilot. | T | - | - |
...
| f018 The library is already booked on Mondays. | T | T | T |
| f019 The library has offered a room for free. | T | F | - |
...
| f023 Each tutor works with at most three students at a time. | T | T | F |
...
| Fact | Truth | herder[local] @ 3000 | herder[local] @ 500 |
| --- | --- | --- | --- |
| f001 The article is a long-form piece for a history magazine on how the shipping container changed ports and port cities. | T | - | - |
| f002 The piece is written for general readers, not maritime specialists. | T | - | - |
| f003 The working title is "The Box That Emptied the Docks". | T | - | - |
| f004 The article must stay under 7,500 words, which is the magazine's hard limit. | T | - | - |
| f005 The article will be about 10,000 words. | F | - | - |
| f006 The article focuses on the years 1956 to 1980. | T | - | - |
...
| f014 The article opens with the Ideal X leaving Newark in April 1956. | T | - | - |
| f015 The Ideal X sailed from Newark in April 1956. | T | - | - |
...
| f018 Every direct quotation must come from a primary source, not from another book. | T | - | - |
| f019 Sidebars are used for technical explanations so the main narrative keeps moving. | T | - | - |
...
| f027 The user prefers concrete numbers — tonnage and dates — to adjectives like 'huge' and 'soon'. | T | - | - |
...
| f007 The start year moved to 2010 because satellite data before that is too coarse. | T | T | - |
...
| f013 Satellite land-surface temperature studies and ground-station studies are discussed in separate sections. | T | - | - |
| f014 Citations use Harvard referencing. | F | F | - |
| f015 Citations use APA 7th edition. | T | T | - |
| f016 The department requires APA 7th. | T | T | - |
| f017 Every temperature figure must state whether it is air temperature or surface temperature. | T | F | - |
...
| f022 The reference list for the chapter is capped at 60, on the supervisor's instruction. | T | - | - |
...
| f032 Whether green roofs belong in this chapter or the next is undecided. | T | T | - |
