# Benchmark run: full-comparison

- Started 2026-09-16T13:38:57+00:00, commit `651cc84`
...
| herder[heuristic] @ 3000 | 0.70 (154 of 221) | 0.00 (0 of 40) | 0.05 (10 of 221) | 9.1x | 13 s | 0 |
| herder[heuristic] @ 500 | 0.45 (99 of 221) | 0.00 (0 of 40) | 0.04 (8 of 221) | 22.7x | 13 s | 0 |
| naive_summary @ 3000 | 0.21 (41 of 195) | 0.09 (3 of 35) | 0.01 (2 of 195) | 5.2x | 176 s | 0 |
| naive_summary @ 500 | 0.05 (10 of 195) | 0.00 (0 of 35) | 0.01 (1 of 195) | 26.1x | 196 s | 0 |
...
| handover | herder[heuristic] @ 500 | 0.48 (27 of 56) | 0.00 (0 of 10) |
...
| planning | herder[heuristic] @ 3000 | 0.65 (34 of 52) | 0.00 (0 of 10) |
| planning | herder[heuristic] @ 500 | 0.54 (28 of 52) | 0.00 (0 of 10) |
...
| research | herder[heuristic] @ 3000 | 0.75 (39 of 52) | 0.00 (0 of 10) |
| research | herder[heuristic] @ 500 | 0.48 (25 of 52) | 0.00 (0 of 10) |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| herder[heuristic] @ 3000 | 0.81 (48 of 59) | 0.84 (27 of 32) | 0.43 (10 of 23) | 0.60 (6 of 10) | 0.67 (45 of 67) | 0.71 (17 of 24) | 0.20 (1 of 5) | - | 0.00 (0 of 1) |
| herder[heuristic] @ 500 | 0.53 (31 of 59) | 0.69 (22 of 32) | 0.48 (11 of 23) | 0.30 (3 of 10) | 0.45 (30 of 67) | 0.08 (2 of 24) | 0.00 (0 of 5) | - | 0.00 (0 of 1) |
...
| --- | --- | --- | --- |
| herder[heuristic] @ 3000 | 0.81 (88 of 108) | 0.58 (51 of 88) | 0.60 (15 of 25) |
| herder[heuristic] @ 500 | 0.61 (66 of 108) | 0.28 (25 of 88) | 0.32 (8 of 25) |
...
| f016 Stock is kept exact to the gram. | T | - | T | - | - | - | T | - |
...
| f022 Reorder suggestions go to Marisol only. | F | - | F | F | F | F | - | - |
| f023 Reorder emails go to both Marisol and the shop manager of the shop concerned. | T | - | T | T | T | T | T | - |
| f024 Reorder suggestions are generated once a night at 2am. | T | - | T | - | - | - | - | - |
| f026 The reorder email is the entire user interface for this version. | T | - | F | F | - | - | F | - |
...
| f035 How to handle stock that expires is still undecided. | T | - | T | - | - | - | T | - |
...
| f038 Rounding hid real shortages, and bakers weigh precisely. | T | - | T | - | - | - | T | - |
...
| f002 snapshelf is written in Go so it ships as a single binary. | T | - | T | - | - | - | - | - |
...
| f010 Photos are sorted into folders by year and then month, like 2024/07. | T | - | T | T | T | T | - | - |
...
| f006 Client files must never be copied onto a personal device, phone or USB stick. | T | - | T | F | - | - | T | T |
...
| f024 New starters get their laptop set up on their first morning. | T | - | T | F | - | T | T | - |
...
| f027 Printer problems are escalated to the leasing company, not fixed in-house. | T | - | T | - | - | - | T | - |
...
| f035 The user never finished documenting the guest Wi-Fi setup. | T | - | F | - | - | - | T | - |
...
| f009 Support can approve refunds under €50 without asking anyone. | T | - | F | - | F | F | - | - |
...
| f017 The team changed the rota handover day last month. | T | - | T | T | - | - | T | - |
...
| f019 Support must not change a customer's calendar settings directly; customers are guided through it themselves. | T | - | T | - | - | - | T | - |
...
| f029 Whether weekend tickets get any response is still undecided. | T | - | T | - | - | - | T | - |
...
| f014 The fit-out budget is £120,000. | F | - | F | - |   |   | - | - |
...
| f029 Whether to serve food beyond pastries is undecided. | T | - | T | - |   |   | T | - |
| f030 The name for the second café is undecided — same name or a variation. | T | - | T | - |   |   | T | T |
| f031 A quote for the espresso machine service contract is still needed. | T | - | T | - |   |   | T | - |
...
| f023 Each tutor works with at most three students at a time. | T | - | F | F | - | - | - | - |
...
| f031 How to measure whether students are improving is undecided. | T | - | T | - | - | - | T | - |
...
| f015 The Ideal X sailed from Newark in April 1956. | T | - | T | - | T | - | T | - |
...
| f029 Whether the labour strikes get their own section is undecided. | T | - | T | - | - | - | T | - |
...
| f010 The chapter is organised by cooling mechanism — shading, evapotranspiration, then albedo. | T | - | T | - | T | - | - | - |
...
| f031 How to handle studies reporting percentages rather than degrees is undecided and parked. | T | - | - | - | - | - | T | - |
| f032 Whether green roofs belong in this chapter or the next is undecided. | T | - | - | - | T | T | T | - |
